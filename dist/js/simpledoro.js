...
$(document).ready(function () {
  ...
  $('.timer_button > a').on('click', function (e) {
    ...
    if (!timerRunning) {
      ...
      var duration; // use "time-left" if timer hasn't been reset
...
function showButton(toggleVal) {
  if (toggleVal == 'start') {
    $('.timer_button > a').removeClass('running').text('START TIMER');
  } else if (toggleVal == 'stop') {
    $('.timer_button > a').addClass('running').text('PAUSE TIMER');
  } // TODO: should say RESUME TIMER
